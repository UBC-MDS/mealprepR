...
test_that("Correct dataframes are returned for splits_to_return=train_test'.", {
...
test_that("Correct dataframes are returned for splits_to_return=train_test_valid'.", {
